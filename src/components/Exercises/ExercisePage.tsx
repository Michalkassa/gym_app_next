    ...
    return(
        <div className="flex flex-col gap-4 text-white">
            ...
            <div className="flex items-center justify-between">
                <Link className="flex items-center gap-2 text-sm text-gray-400 transition hover:text-white" href="/dashboard/exercises">
            ...
            <Modal modalOpen={openModalDelete} setModalOpen={setModalOpenDelete}>
                <div className="flex flex-col gap-4">
                    <h3 className="text-lg font-bold">Delete exercise “{name}”?</h3>
                    <p className="text-gray-400">This can’t be undone — all logs for this exercise are removed too.</p>
            ...
            <Modal modalOpen={openModalNameEdit} setModalOpen={setModalNameOpenEdit}>
                <div className="flex flex-col gap-4">
                    ...
                    <form autoComplete="off" action={() => editExercise(id,nameToEdit,descriptionToEdit)} onSubmit={handleNameEdit} className="flex flex-col gap-3">
                        <input maxLength={15} autoComplete="false" required value={nameToEdit} onChange={(e) => setNameToEdit(e.target.value)} id="name" name="name" type="text" placeholder="Exercise name" className="input-field"></input>
