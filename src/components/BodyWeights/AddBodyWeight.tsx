  ...
  return (
    <div>
      ...
      <Modal modalOpen={modalOpen} setModalOpen={setModalOpen}>
        <form action={addBodyWeight} className="flex flex-col gap-3">
          <h3 className="font-bold text-lg">Add new Body Weight</h3>
          <div className="flex gap-3">
            <input id="weight" name="weight" type="number" step="0.01" min="0" placeholder="Type Here" className="input input-bordered w-full text-black p-3"></input>
            <button
